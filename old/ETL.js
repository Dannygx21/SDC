...
async function importCsvProgrammatically(dbName, collectionName, csvFilePath, mongoUrl = DB_URL) {
    console.log(DB_URL)
...
// Example usage:
importCsvProgrammatically('Catwalk-old', 'Features', path.resolve(dataPath, 'Product', 'Copy of features.csv'), DB_URL);